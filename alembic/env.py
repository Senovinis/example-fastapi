...
#ima is models Base, o ne database
...
#Ima is settings, nes config.py klase Settings sukurta. Pakopijavo is esmes database.py faile esancia eilute su variablais
